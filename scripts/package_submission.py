...
# does render fresh. START_HERE.txt points an evaluator at exactly those two
# PDFs by name so they don't have to guess which files matter in a zip full
# of source code and generated outputs.
REQUIRED_PATHS = [
    "START_HERE.txt",
    "notebook.ipynb",
    "data/simulator.py",
